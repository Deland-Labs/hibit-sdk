...
export default function ChainIdSelector({ selectedChainIds, onChange, error }: ChainIdSelectorProps) {
  ...
  return (
    <FormField label="ChainIds" labelDesc="select multiple chains" error={error}>
